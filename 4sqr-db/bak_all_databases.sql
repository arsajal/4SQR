...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 15, 2025 at 12:32 PM
...
('def', 'demo', 'home_slider', 'sl', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'demo', 'home_slider', 'id', 2, NULL, 'NO', 'varchar', 12, 12, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(12)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'demo', 'home_slider', 'status', 3, NULL, 'NO', 'varchar', 1, 1, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(1)', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'home_slider', 'updateOn', 4, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'home_slider', 'userid', 5, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'home_slider', 'removeOn', 6, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'home_slider', 'userid2', 7, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'work_group', 'sl', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'demo', 'work_group', 'id', 2, NULL, 'NO', 'varchar', 12, 12, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(12)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'demo', 'work_group', 'title', 3, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'demo', 'work_group', 'bgpic', 4, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'work_group', 'status', 5, NULL, 'NO', 'varchar', 1, 1, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(1)', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'work_group', 'updateOn', 6, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'work_group', 'userid', 7, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'work_group', 'removeOn', 8, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'work_group', 'userid2', 9, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'works', 'sl', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'demo', 'works', 'work', 2, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'demo', 'works', 'client', 3, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'works', 'id', 4, NULL, 'NO', 'varchar', 12, 12, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(12)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'demo', 'works', 'intro', 5, NULL, 'NO', 'varchar', 12, 12, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(12)', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'works', 'details', 6, NULL, 'YES', 'varchar', 500, 500, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(500)', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'works', 'status', 7, NULL, 'NO', 'varchar', 1, 1, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(1)', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'works', 'updateOn', 8, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'works', 'userid', 9, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'works', 'removeOn', 10, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'works', 'userid2', 11, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'works_details', 'sl', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'demo', 'works_details', 'id', 2, NULL, 'NO', 'varchar', 12, 12, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(12)', 'MUL', '', 'select,insert,update,references', 'work id'),
('def', 'demo', 'works_details', 'pic', 3, NULL, 'NO', 'varchar', 12, 12, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(12)', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'works_details', 'status', 4, NULL, 'NO', 'varchar', 1, 1, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(1)', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'works_details', 'updateOn', 5, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'works_details', 'userid', 6, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'works_details', 'removeOn', 7, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'demo', 'works_details', 'userid2', 8, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
...
('def', 'mysql', 'plugin', 'name', 1, '', 'NO', 'char', 64, 192, NULL, NULL, 'utf8', 'utf8_bin', 'char(64)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mysql', 'plugin', 'dl', 2, '', 'NO', 'char', 128, 384, NULL, NULL, 'utf8', 'utf8_bin', 'char(128)', '', '', 'select,insert,update,references', ''),
...
('INNODB_BUFFER_POOL_READ_REQUESTS', '581'),
...
('FT_MAX_WORD_LEN', '84'),
('PID_FILE', 'D:\\demo\\mysql\\Data\\sajal-pc.pid'),
...
('CHARACTER_SETS_DIR', 'D:\\demo\\mysql\\share\\charsets\\'),
...
('SQL_NOTES', 'ON'),
('LC_MESSAGES_DIR', 'D:\\demo\\mysql\\share\\'),
...
('GENERAL_LOG_FILE', 'D:\\demo\\mysql\\Data\\sajal-pc.log'),
('SQL_BIG_SELECTS', 'ON'),
('PERFORMANCE_SCHEMA_MAX_COND_CLASSES', '80'),
('MAX_SEEKS_FOR_KEY', '4294967295'),
('AUTO_INCREMENT_INCREMENT', '1'),
('SKIP_NAME_RESOLVE', 'OFF'),
('TMPDIR', 'C:\\Users\\arsaj\\AppData\\Local\\Temp'),
...
('HAVE_GEOMETRY', 'YES'),
('SLOW_QUERY_LOG_FILE', 'D:\\demo\\mysql\\Data\\sajal-pc-slow.log'),
...
('LOG_ERROR', 'D:\\demo\\mysql\\Data\\sajal-pc.err'),
...
('LC_TIME_NAMES', 'en_US'),
('PLUGIN_DIR', 'D:\\demo\\mysql\\lib/plugin'),
('TIME_FORMAT', '%H:%i:%s'),
...
('SLAVE_LOAD_TMPDIR', 'C:\\Users\\arsaj\\AppData\\Local\\Temp'),
...
('def', 'demo', 'PRIMARY', 'def', 'demo', 'home_slider', 'sl', 1, NULL, NULL, NULL, NULL),
('def', 'demo', 'id', 'def', 'demo', 'home_slider', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'demo', 'PRIMARY', 'def', 'demo', 'work_group', 'sl', 1, NULL, NULL, NULL, NULL),
('def', 'demo', 'id', 'def', 'demo', 'work_group', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'demo', 'title', 'def', 'demo', 'work_group', 'title', 1, NULL, NULL, NULL, NULL),
('def', 'demo', 'PRIMARY', 'def', 'demo', 'works', 'sl', 1, NULL, NULL, NULL, NULL),
('def', 'demo', 'id', 'def', 'demo', 'works', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'demo', 'work', 'def', 'demo', 'works', 'work', 1, NULL, NULL, NULL, NULL),
('def', 'demo', 'work', 'def', 'demo', 'works', 'client', 2, NULL, NULL, NULL, NULL),
('def', 'demo', 'PRIMARY', 'def', 'demo', 'works_details', 'sl', 1, NULL, NULL, NULL, NULL),
('def', 'demo', 'id', 'def', 'demo', 'works_details', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'demo', 'id', 'def', 'demo', 'works_details', 'pic', 2, NULL, NULL, NULL, NULL),
...
--
-- in use (#1548 - Cannot load from mysql.proc. The table is probably corrupted)
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 5242752, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 5242776, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 5242770, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-10-15 12:32:59', '2025-10-15 12:32:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 5242860, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 5242510, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-10-15 12:32:59', '2025-10-15 12:32:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 5241566, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 5241872, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 5241872, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 5239810, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-10-15 12:32:59', '2025-10-15 12:32:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-10-15 12:32:59', '2025-10-15 12:32:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-10-15 12:32:59', '2025-10-15 12:32:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-10-15 12:32:59', '2025-10-15 12:32:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 5242776, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 5242446, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-10-15 12:32:59', '2025-10-15 12:32:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 5241032, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 5242674, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 5241872, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 5241872, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 5240983, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 5235300, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 5241054, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 5240872, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 5242120, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-10-15 12:32:59', '2025-10-15 12:32:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 5241054, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-10-15 12:32:59', '2025-10-15 12:32:59', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 5242875, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 5241304, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 5242852, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 5242448, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 5242852, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 5242875, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 5217748, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'demo', 'home_slider', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 52, 52, 281474976710655, 3072, 0, '2025-10-15 00:30:34', '2025-10-15 00:31:30', NULL, NULL, '', '', NULL),
('def', 'demo', 'work_group', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, 73, 660, 281474976710655, 4096, 0, '2025-10-15 00:21:32', '2025-10-15 00:21:32', NULL, NULL, '', '', NULL),
('def', 'demo', 'works', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 84, 252, 281474976710655, 4096, 0, '2025-10-15 00:21:32', '2025-10-15 00:21:32', NULL, NULL, '', '', NULL),
('def', 'demo', 'works_details', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 21, 58, 1236, 281474976710655, 3072, 0, '2025-10-15 00:21:32', '2025-10-15 00:21:32', NULL, NULL, '', '', NULL),
('def', 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 880, 123848989752688639, 5120, 880, '2009-05-15 00:27:58', '2009-07-06 01:51:22', '2009-05-15 00:28:00', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2009-05-15 00:28:00', '2009-05-15 01:28:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 37, 581, 21497, 163536961468891135, 3072, 0, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 450, 197, 88650, 55450570411999231, 16384, 0, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 988, 9, 8892, 2533274790395903, 16384, 0, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 504, 822, 414600, 281474976710655, 20480, 0, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2009-05-15 00:27:58', '2025-10-15 12:31:28', NULL, NULL, '', '', NULL),
('def', 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2009-05-15 00:28:00', '2009-05-15 01:28:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162411061562048511, 1024, 0, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, NULL, '', '', NULL),
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 52, 152, 281474976710655, 2048, 48, '2009-05-15 00:27:58', '2009-07-06 01:51:22', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_bookmark', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-10-15 00:12:03', '2025-10-15 00:12:03', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_column_info', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 4096, 0, '2025-10-15 00:12:03', '2025-10-15 00:12:03', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_designer_coords', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2025-10-15 00:12:03', '2025-10-15 00:12:03', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_history', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 16, 115, 1840, 281474976710655, 8192, 0, '2025-10-15 00:12:03', '2025-10-15 00:12:03', '2025-10-15 00:12:03', NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_pdf_pages', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2025-10-15 00:12:03', '2025-10-15 00:12:03', '2025-10-15 00:12:03', NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 4096, 0, '2025-10-15 00:12:03', '2025-10-15 00:12:03', '2025-10-15 00:12:03', NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_table_coords', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2025-10-15 00:12:03', '2025-10-15 00:12:03', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_table_info', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2025-10-15 00:12:03', '2025-10-15 00:12:03', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_tracking', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2025-10-15 00:12:03', '2025-10-15 00:12:03', NULL, NULL, '', '', NULL);
...
(13, 'root', 'localhost:60196', 'demo', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'demo', 'home_slider', 0, 'demo', 'PRIMARY', 1, 'sl', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'demo', 'home_slider', 0, 'demo', 'id', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'demo', 'work_group', 0, 'demo', 'PRIMARY', 1, 'sl', 'A', 9, NULL, NULL, '', 'BTREE', '', ''),
('def', 'demo', 'work_group', 0, 'demo', 'id', 1, 'id', 'A', 9, NULL, NULL, '', 'BTREE', '', ''),
('def', 'demo', 'work_group', 0, 'demo', 'title', 1, 'title', 'A', 9, NULL, NULL, '', 'BTREE', '', ''),
('def', 'demo', 'works', 0, 'demo', 'PRIMARY', 1, 'sl', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'demo', 'works', 0, 'demo', 'id', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'demo', 'works', 0, 'demo', 'work', 1, 'work', 'A', NULL, NULL, NULL, '', 'BTREE', '', ''),
('def', 'demo', 'works', 0, 'demo', 'work', 2, 'client', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'demo', 'works_details', 0, 'demo', 'PRIMARY', 1, 'sl', 'A', 21, NULL, NULL, '', 'BTREE', '', ''),
('def', 'demo', 'works_details', 0, 'demo', 'id', 1, 'id', 'A', NULL, NULL, NULL, '', 'BTREE', '', ''),
('def', 'demo', 'works_details', 0, 'demo', 'id', 2, 'pic', 'A', 21, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'mysql', 'help_category', 0, 'mysql', 'PRIMARY', 1, 'help_category_id', 'A', 37, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mysql', 'help_category', 0, 'mysql', 'name', 1, 'name', 'A', 37, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mysql', 'help_keyword', 0, 'mysql', 'PRIMARY', 1, 'help_keyword_id', 'A', 450, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mysql', 'help_keyword', 0, 'mysql', 'name', 1, 'name', 'A', 450, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mysql', 'help_relation', 0, 'mysql', 'PRIMARY', 1, 'help_keyword_id', 'A', NULL, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mysql', 'help_relation', 0, 'mysql', 'PRIMARY', 2, 'help_topic_id', 'A', 988, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mysql', 'help_topic', 0, 'mysql', 'PRIMARY', 1, 'help_topic_id', 'A', 504, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mysql', 'help_topic', 0, 'mysql', 'name', 1, 'name', 'A', 504, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'phpmyadmin', 'pma_history', 0, 'phpmyadmin', 'PRIMARY', 1, 'id', 'A', 16, NULL, NULL, '', 'BTREE', '', ''),
('def', 'phpmyadmin', 'pma_history', 1, 'phpmyadmin', 'username', 1, 'username', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'phpmyadmin', 'pma_history', 1, 'phpmyadmin', 'username', 2, 'db', 'A', 16, NULL, NULL, '', 'BTREE', '', ''),
('def', 'phpmyadmin', 'pma_history', 1, 'phpmyadmin', 'username', 3, 'table', 'A', 16, NULL, NULL, '', 'BTREE', '', ''),
('def', 'phpmyadmin', 'pma_history', 1, 'phpmyadmin', 'username', 4, 'timevalue', 'A', 16, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 5242752, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=13653', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 5242776, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=22696', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 5242770, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=26886', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2025-10-15 12:32:59', '2025-10-15 12:32:59', NULL, 'utf8_general_ci', NULL, 'max_rows=875', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 5242860, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2044', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 5242510, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=10699', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2025-10-15 12:32:59', '2025-10-15 12:32:59', NULL, 'utf8_general_ci', NULL, 'max_rows=193', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 5241566, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1958', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 5241872, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1604', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 5241872, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1604', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 5239810, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1130', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2025-10-15 12:32:59', '2025-10-15 12:32:59', NULL, 'utf8_general_ci', NULL, 'max_rows=1890', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2025-10-15 12:32:59', '2025-10-15 12:32:59', NULL, 'utf8_general_ci', NULL, 'max_rows=1743', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2025-10-15 12:32:59', '2025-10-15 12:32:59', NULL, 'utf8_general_ci', NULL, 'max_rows=3540', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2025-10-15 12:32:59', '2025-10-15 12:32:59', NULL, 'utf8_general_ci', NULL, 'max_rows=7468', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 5242776, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=17022', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 5242446, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1089', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2025-10-15 12:32:59', '2025-10-15 12:32:59', NULL, 'utf8_general_ci', NULL, 'max_rows=182', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 5241032, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1513', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 5242674, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2406', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 5241872, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1604', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 5241872, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1604', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 5240983, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=911', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 5235300, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=554', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 5241054, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=754', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 5240872, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2093', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 5242120, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2210', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2025-10-15 12:32:59', '2025-10-15 12:32:59', NULL, 'utf8_general_ci', NULL, 'max_rows=177', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 5241054, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2639', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2025-10-15 12:32:59', '2025-10-15 12:32:59', NULL, 'utf8_general_ci', NULL, 'max_rows=2167', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 5242875, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=209715', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 5241304, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1156', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 5242852, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=180788', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 5242448, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8752', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 5242852, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=180788', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 5242875, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=209715', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 5217748, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=167', ''),
('def', 'demo', 'home_slider', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 52, 52, 281474976710655, 3072, 0, 2, '2025-10-15 00:30:34', '2025-10-15 00:31:30', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'demo', 'work_group', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 9, 73, 660, 281474976710655, 4096, 0, 11, '2025-10-15 00:21:32', '2025-10-15 00:21:32', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'demo', 'works', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 3, 84, 252, 281474976710655, 4096, 0, 5, '2025-10-15 00:21:32', '2025-10-15 00:21:32', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'demo', 'works_details', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 21, 58, 1236, 281474976710655, 3072, 0, 22, '2025-10-15 00:21:32', '2025-10-15 00:21:32', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 880, 123848989752688639, 5120, 880, NULL, '2009-05-15 00:27:58', '2009-07-06 01:51:22', '2009-05-15 00:28:00', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2009-05-15 00:28:00', '2009-05-15 01:28:00', NULL, 'utf8_general_ci', NULL, '', 'Events'),
('def', 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
('def', 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
('def', 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 37, 581, 21497, 163536961468891135, 3072, 0, NULL, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
('def', 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 450, 197, 88650, 55450570411999231, 16384, 0, NULL, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
('def', 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 988, 9, 8892, 2533274790395903, 16384, 0, NULL, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
('def', 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 504, 822, 414600, 281474976710655, 20480, 0, NULL, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
('def', 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2009-05-15 00:27:58', '2025-10-15 12:31:28', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
('def', 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2009-05-15 00:28:00', '2009-05-15 01:28:00', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162411061562048511, 1024, 0, NULL, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, 'utf8_bin', NULL, '', 'MySQL plugins'),
('def', 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
('def', 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
('def', 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
('def', 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
('def', 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
('def', 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
('def', 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
('def', 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
('def', 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
('def', 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2009-05-15 00:27:59', '2009-05-15 01:28:00', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 52, 152, 281474976710655, 2048, 48, NULL, '2009-05-15 00:27:58', '2009-07-06 01:51:22', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
('def', 'phpmyadmin', 'pma_bookmark', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2025-10-15 00:12:03', '2025-10-15 00:12:03', NULL, 'utf8_bin', NULL, '', 'Bookmarks'),
('def', 'phpmyadmin', 'pma_column_info', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 4096, 0, 1, '2025-10-15 00:12:03', '2025-10-15 00:12:03', NULL, 'utf8_bin', NULL, '', 'Column information for phpMyAdmin'),
('def', 'phpmyadmin', 'pma_designer_coords', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2025-10-15 00:12:03', '2025-10-15 00:12:03', NULL, 'utf8_bin', NULL, '', 'Table coordinates for Designer'),
('def', 'phpmyadmin', 'pma_history', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 16, 115, 1840, 281474976710655, 8192, 0, 17, '2025-10-15 00:12:03', '2025-10-15 00:12:03', '2025-10-15 00:12:03', 'utf8_bin', NULL, '', 'SQL history for phpMyAdmin'),
('def', 'phpmyadmin', 'pma_pdf_pages', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2025-10-15 00:12:03', '2025-10-15 00:12:03', '2025-10-15 00:12:03', 'utf8_bin', NULL, '', 'PDF relation pages for phpMyAdmin'),
('def', 'phpmyadmin', 'pma_relation', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 4096, 0, NULL, '2025-10-15 00:12:03', '2025-10-15 00:12:03', '2025-10-15 00:12:03', 'utf8_bin', NULL, '', 'Relation table'),
('def', 'phpmyadmin', 'pma_table_coords', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2025-10-15 00:12:03', '2025-10-15 00:12:03', NULL, 'utf8_bin', NULL, '', 'Table coordinates for phpMyAdmin PDF output'),
('def', 'phpmyadmin', 'pma_table_info', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2025-10-15 00:12:03', '2025-10-15 00:12:03', NULL, 'utf8_bin', NULL, '', 'Table information for phpMyAdmin'),
('def', 'phpmyadmin', 'pma_tracking', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2025-10-15 00:12:03', '2025-10-15 00:12:03', NULL, 'utf8_bin', NULL, 'row_format=COMPACT', '');
...
('def', 'demo', 'PRIMARY', 'demo', 'home_slider', 'PRIMARY KEY'),
('def', 'demo', 'id', 'demo', 'home_slider', 'UNIQUE'),
('def', 'demo', 'PRIMARY', 'demo', 'work_group', 'PRIMARY KEY'),
('def', 'demo', 'id', 'demo', 'work_group', 'UNIQUE'),
('def', 'demo', 'title', 'demo', 'work_group', 'UNIQUE'),
('def', 'demo', 'PRIMARY', 'demo', 'works', 'PRIMARY KEY'),
('def', 'demo', 'id', 'demo', 'works', 'UNIQUE'),
('def', 'demo', 'work', 'demo', 'works', 'UNIQUE'),
('def', 'demo', 'PRIMARY', 'demo', 'works_details', 'PRIMARY KEY'),
('def', 'demo', 'id', 'demo', 'works_details', 'UNIQUE'),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='SQL history for phpMyAdmin' AUTO_INCREMENT=17 ;
...
(1, 'root', 'gtd', '', '2008-01-24 05:03:46', 'DROP TABLE `categories`, `checklist`, `checklistitems`, `context`, `goals`, `itemattributes`, `items`, `itemstatus`, `list`, `listitems`, `nextactions`, `projectattributes`, `projects`, `projectstatus`, `tickler`, `timeitems`;'),
(2, 'root', 'xoops', '', '2008-01-24 05:28:31', 'DROP TABLE `xoops_avatar`, `xoops_avatar_user_link`, `xoops_banner`, `xoops_bannerclient`, `xoops_bannerfinish`, `xoops_block_module_link`, `xoops_config`, `xoops_configcategory`, `xoops_configoption`, `xoops_groups`, `xoops_groups_users_link`, `xoops_group_permission`, `xoops_image`, `xoops_imagebody`, `xoops_imagecategory`, `xoops_imgset`, `xoops_imgsetimg`, `xoops_imgset_tplset_link`, `xoops_modules`, `xoops_newblocks`, `xoops_online`, `xoops_priv_msgs`, `xoops_ranks`, `xoops_session`, `xoops_smiles`, `xoops_tplfile`, `xoops_tplset`, `xoops_tplsource`, `xoops_users`, `xoops_xoopscomments`, `xoops_xoopsnotifications`;'),
(3, 'root', 'tine', '', '2010-02-21 23:31:15', 'CREATE DATABASE `tine`;'),
(4, 'root', 'elgg', '', '2010-02-21 23:32:19', 'CREATE DATABASE `elgg`;'),
(5, 'root', 'osticket', '', '2010-02-21 23:46:12', 'CREATE DATABASE `osticket`;'),
(6, 'root', 'openx', '', '2010-02-21 23:51:16', 'CREATE DATABASE `openx`;'),
(7, 'root', '', '', '2010-02-21 23:56:05', 'DROP DATABASE `openx`'),
(8, 'root', 'gallery2', '', '2010-02-21 23:56:10', 'CREATE DATABASE `gallery2`;'),
(9, 'root', 'epiware', '', '2010-02-22 00:13:50', 'CREATE DATABASE `epiware`;'),
(10, 'root', 'ocportal', '', '2010-02-22 00:17:22', 'CREATE DATABASE `ocportal`;'),
(11, 'root', 'mantisbt', 'mantis_user_table', '2010-02-22 00:23:58', 'SELECT * FROM `mantis_user_table`'),
(12, 'root', 'mantisbt', 'mantis_user_table', '2010-02-22 00:24:01', 'SELECT * FROM `mantis_user_table`'),
(13, 'root', 'mantisbt', 'mantis_user_table', '2010-02-22 00:24:08', 'SELECT * FROM `mantis_user_table`'),
(14, 'root', 'mantisbt', 'mantis_user_table', '2010-02-22 00:24:31', 'SELECT * FROM `mantis_user_table`'),
(15, 'root', 'mantisbt', 'mantis_user_table', '2010-02-22 00:24:35', 'SELECT * FROM `mantis_user_table`'),
(16, 'root', 'enano', '', '2010-02-22 00:27:49', 'CREATE DATABASE `enano`;');
