						...
						<div class="cat-grid-item-col">
							<div class="cat-grid-item cgiid-title-scale">
								<div class="cat-grd-itm-img-cntlr">
									<a class="overlay-link" href="work_type.php?name=RESIDENCE"></a>
									<div class="cat-grd-itm-img-bg"></div>
									<div class="cat-grd-itm-img inline-bg bg-imgH" data-height="667" data-width="1000" style="background-image: url('images/work/DJI_0035-copy.jpg');"></div>
									<div class="cat-grd-itm-img-des"><h3 class="fl-h3 cgiid-title">RESIDENCE</h3></div>
								</div>
							</div>
						</div>
					</li>
